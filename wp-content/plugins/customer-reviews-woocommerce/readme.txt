...
The plugin works as an interface to an external service for verification of customer reviews. The service called CusRev (Customer Reviews) facilitates collection of reviews from customers (including people who never bother to write reviews) and increases impact of reviews on purchasing decisions by verifying their authenticity. Information about [terms](https://www.cusrev.com/terms.html), [privacy](https://www.cusrev.com/privacy-policy), and [data protection](https://www.cusrev.com/data-protection) policies of CusRev is provided on [Cusrev website](https://www.cusrev.com/business/).
...
* After submission of the review form, the plugin will transfer reviews to pages of individual products and save them in the standard WooCommerce format
...
* Reply to reviews left by your customers
...
* Lazy load of reviews
* Sort reviews by date or votes
* Review tagging
* Built-in [cusrev_all_reviews] shortcode to display a list of reviews on any page or post of a website. Additional information about this shortcode is on the settings page of the plugin.
* Built-in [cusrev_reviews_grid] shortcode to display a grid of reviews on any page or post of a website. Additional information about this shortcode is on the settings page of the plugin.
* Built-in [cusrev_reviews_slider] shortcode to display a responsive reviews slider on any page or post of a website. Additional information about this shortcode is on the settings page of the plugin.
...
* Works out of the box by using a responsive email template with custom colors
* Built-in testing tool to make sure that emails look beautifully before sending them
* Emails with coupons in different languages via an integration with "qTranslate X", "Polylang", and "WPML" plugins
...
Enhance the standard WooCommerce structured data markup with product identifiers (GTIN, MPN, Brand).
...
* Export reviews into a CSV file.

=== How does it work? ===

The recommended way of using the plugin is as follows:

1. A customer makes a purchase from your online store.
2. You process their order and set status of the order as “Completed” (or other paid order status configured in the settings).
3. After a certain delay (configured in the settings), the customer will receive an email with an invitation to leave a review.
4. The customer writes reviews about products using a simple form hosted on an independent third-party domain (to remove suspicion that you could have created positive reviews yourself).
5. The reviews are transferred from the form to WooCommerce, saved to the database in the standard WooCommerce format, and published.
6. The customer (optionally) receives an email containing a discount coupon for future purchases in your store.

=== Easy to Get Started ===

Simply follow [Getting Started Tutorial](https://help.cusrev.com/support/solutions/articles/43000051291-getting-started-tutorial) on our official support portal or watch the video tutorial created by one of our partners.
...
CusRev service has two plans: Free and Pro. The professional plan offers additional features and dedicated support by email. You can purchase a license for the Pro plan here: [official CusRev website](https://www.cusrev.com/business/).
...
2. Let customers attach pictures and videos to reviews
3. [cusrev_reviews_slider] shortcode to display a responsive reviews slider on any page or post of a website (also available as a Gutenberg block)
4. [cusrev_reviews_grid] shortcode to display a grid of product reviews on any page or post of a website (also available as a Gutenberg block)
5. A sample review form generated by the plugin
6. The reviews summary bar
7. Voting buttons for reviews
8. A Trust Badge block to showcase a summary of verified reviews (also available as a Gutenberg block)
9. A button to attach pictures to reviews
10. reCAPTCHA field to prevent fake reviews
11. A customer review with a picture
12. [cusrev_all_reviews] shortcode to display reviews for all products on any page or post of a website
13. A sample email with an invitation to review products
14. A sample email with a discount code
15. WooCommerce Orders page with manual reminders option enabled
16. Import reviews page
